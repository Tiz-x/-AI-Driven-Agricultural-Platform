...
// ── Crop options ──────────────────────────────────────
const CROP_OPTIONS = ["Maize", "Pepper", "Tomato", "Cassava"];
    ...
    <div className={styles.shell}>
      ...
      <div className={styles.left}>
        <div
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=900&q=90')`,
          }}
        />
            ...
            <div className={styles.fields}>
              ...
              <div className={styles.fieldGroup}>
                <label className={styles.fieldLabel}>
                  Crop Types{" "}
                  {tab === "buyer-seller"
                    ? `(${intent === "buy" ? "Interested In" : "Available"})`
                    : ""}
                </label>
                <CropPicker
